...
const speakingSections = [
    { name: 'Read Aloud', path: '/versant-mock-test/module/readAloud', icon: <FaBookOpen />, description: 'Read the displayed sentence aloud clearly.' },
    { name: 'Repeats', path: '/versant-mock-test/module/repeats', icon: <FaMicrophone />, description: 'Listen to a sentence and repeat it exactly.' },
    { name: 'Short Answer', path: '/versant-mock-test/module/shortAnswer', icon: <FaQuestion />, description: 'Listen to a question and answer with a single word or phrase.' },
    { name: 'Sentence Builds', path: '/versant-mock-test/module/sentenceBuilds', icon: <FaPuzzlePiece />, description: 'Listen to jumbled phrases and rearrange them into a sentence.' },
    { name: 'Story Retelling', path: '/versant-mock-test/module/storyRetelling', icon: <FaHeadphones />, description: 'Listen to a short story and retell it in your own words.' },
    { name: 'Open Questions', path: '/versant-mock-test/module/openQuestions', icon: <FaCommentDots />, description: 'Speak for 40 seconds on a general topic.' },
];
